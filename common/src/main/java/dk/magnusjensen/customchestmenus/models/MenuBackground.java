...
public record MenuBackground(ResourceLocation texture, Vector2i size, boolean showPlayerInventory, Optional<Vector2i> titleLocation) {
    public static final MenuBackground DEFAULT = new MenuBackground(ResourceLocation.tryParse("textures/gui/container/generic_54.png"), new Vector2i(0, 0), true, Optional.empty());
    ...
    public static final Codec<MenuBackground> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        ResourceLocation.CODEC.fieldOf("texture").forGetter(MenuBackground::texture),
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, MenuBackground> STREAM_CODEC = StreamCodec.composite(
        ResourceLocation.STREAM_CODEC, MenuBackground::texture,
