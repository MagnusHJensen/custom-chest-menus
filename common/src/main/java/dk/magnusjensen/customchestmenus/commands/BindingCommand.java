                ...
                .then(Commands.argument("menu", StringArgumentType.word())
                    ...
                    .executes(ctx -> {
                        ...
                        if (playerData != null && !playerData.isBindingMode()) {
                            ...
                            player.sendSystemMessage(Component.literal("Binding mode activated for menu: " + menuDef.id() + ". Right-click a block to bind it."), true);
            ...
            .then(Commands.literal("unbind")
                .executes(ctx -> {
                    ...
                    if (playerData != null && !playerData.isUnbindingMode()) {
                        ...
                        Services.ATTACHMENT.setPlayerAttachment(player, playerData);
                        player.sendSystemMessage(Component.literal("Unbinding mode activated. Right-click a block to unbind it."), true);
            ...
            .then(Commands.literal("list-bindings")
                .executes(ctx -> {
                    ...
                    if (interactiveBlocks.isEmpty()) {
                        ctx.getSource().sendSuccess(() -> Component.literal("No blocks are currently bound to menus."), false);
                    } else {
