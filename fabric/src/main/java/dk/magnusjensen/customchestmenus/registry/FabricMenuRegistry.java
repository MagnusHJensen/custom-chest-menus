...
public class FabricMenuRegistry {
    public static final MenuType<CustomChestMenu> CUSTOM_CHEST_MENU = Registry.register(
        ...
        new ResourceLocation(Constants.MOD_ID, "custom_chest_menu"),
        new ExtendedScreenHandlerType<>(CustomChestMenu::new) // factory: (syncId, playerInv) -> new MyMenu(syncId, playerInv)
    );
